...
if( $xmldarepin->nextElement('shared') ) { # for each combination of nondrsv shared with specific san
    my @nondrsvnamessharedspec=(); # list of names of nondrsv shared among specific SAN
    my $sharednondrsvspecsan = $xmldarepin->copyCurrentNode(1); # the combination of shared nondrsv and san
